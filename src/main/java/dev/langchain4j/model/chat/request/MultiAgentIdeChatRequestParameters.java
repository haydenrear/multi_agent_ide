...
public class MultiAgentIdeChatRequestParameters implements ChatRequestParameters{

    public static final ChatRequestParameters EMPTY =
            MultiAgentIdeChatRequestParameters.builder().build();
    ...
    protected MultiAgentIdeChatRequestParameters(MultiAgentIdeChatRequestParameters.Builder<?> builder) {
    ...
    public boolean equals(final Object o) {
        ...
        MultiAgentIdeChatRequestParameters that = (MultiAgentIdeChatRequestParameters) o;
    ...
    public String toString() {
        return "MultiAgentIdeChatRequestParameters{" + "modelName='"
    ...
    public static MultiAgentIdeChatRequestParameters.Builder<?> builder() {
        return new MultiAgentIdeChatRequestParameters.Builder<>();
    }

    public static class Builder<T extends MultiAgentIdeChatRequestParameters.Builder<T>> {
        ...
        public T overrideWith(ChatRequestParameters parameters) {
            ...
            if (parameters instanceof MultiAgentIdeChatRequestParameters p && p.memoryId != null) {
                memoryId(p.memoryId);
            }
        ...
        public ChatRequestParameters build() {
            return new MultiAgentIdeChatRequestParameters(this);
        }
    }
