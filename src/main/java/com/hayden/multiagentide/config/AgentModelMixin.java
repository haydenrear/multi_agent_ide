...
public interface AgentModelMixin {
    ...
    @JsonSubTypes({
        // Interrupt Requests
        @JsonSubTypes.Type(value = AgentModels.OrchestratorInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.OrchestratorCollectorInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.DiscoveryOrchestratorInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.DiscoveryAgentInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.DiscoveryCollectorInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.DiscoveryAgentDispatchInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.PlanningOrchestratorInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.PlanningAgentInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.PlanningCollectorInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.PlanningAgentDispatchInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.TicketOrchestratorInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.TicketAgentInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.TicketCollectorInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.TicketAgentDispatchInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.ReviewInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.MergerInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.ContextManagerInterruptRequest.class),
        @JsonSubTypes.Type(value = AgentModels.QuestionAnswerInterruptRequest.class),
        ...
        // Supporting types
        @JsonSubTypes.Type(value = AgentModels.StructuredChoice.class),
        @JsonSubTypes.Type(value = AgentModels.ConfirmationItem.class),
        @JsonSubTypes.Type(value = AgentModels.InterruptResolution.class),
